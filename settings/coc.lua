...
-- Helper function for CheckBackspace (made global for v:lua access if needed, but local usage above covers it)
...
keyset("v", "<C-b>", 'coc#float#has_scroll() ? coc#float#scroll(0) : "<C-b>"', opts_scroll)
...
keyset("n", "<space>j", ":<C-u>CocNext<CR>", opts_list)
keyset("n", "<space>k", ":<C-u>CocPrev<CR>", opts_list)
keyset("n", "<space>p", ":<C-u>CocListResume<CR>", opts_list)
